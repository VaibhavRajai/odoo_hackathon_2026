...
import { LogOut, User as UserIcon, Shield, Layers, Sun, Moon, Menu, X, Truck, Users, MapPin, ShieldCheck, Wrench, Map, Fuel } from "lucide-react";
        ...
        <nav className="space-y-1.5">
          ...
          {user.role === "Dispatcher" && (
            <>
              ...
              >
                <Map className={`h-4 w-4 ${pathname.startsWith("/dispatch") && !pathname.startsWith("/dispatch/expenses") ? "text-blue-500" : ""}`} /> Dispatch Board
              </a>
              <a
              ...
              >
                <Fuel className={`h-4 w-4 ${pathname.startsWith("/dispatch/expenses") ? "text-amber-500" : ""}`} /> Fuel & Expenses
              </a>
            </>
          )}
        </nav>
