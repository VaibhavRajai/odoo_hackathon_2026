    ...
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div>
        ...
        <p className="text-zinc-550 dark:text-zinc-400 mt-2">
          Welcome back, {name || "Analyst"}. Review operation costs and revenue margins.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          <div
            key={idx}
            className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/40 p-6 backdrop-blur-sm shadow-sm transition-colors duration-200"
          >
            ...
            <div className="mt-4">
              ...
              <span className="block text-xs text-zinc-550 dark:text-zinc-550 mt-1">
                {item.change}
              </span>
            </div>
          </div>
      ...
      <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/20 p-6 backdrop-blur-sm transition-colors duration-200">
        <h2 className="text-lg font-bold text-zinc-900 dark:text-white mb-4">
          Operations Cost Breakdown (Current Month)
        </h2>
        <div className="overflow-x-auto">
          <table className="w-full min-w-[600px] text-left text-sm text-zinc-550 dark:text-zinc-400 border-collapse">
            <thead>
              ...
              {[
                {
                  ...
                  variance: "-$3,800",
                  status: "Optimal",
                  statusCol: "text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 border-emerald-500/20",
                },
                {
                  ...
                  statusCol: "text-amber-600 dark:text-amber-400 bg-amber-500/10 border-amber-500/20",
                },
                {
                  category: "Driver Payroll & Allowances",
                  budget: "$60,000",
                  actual: "$59,800",
                  variance: "-$200",
                  status: "Balanced",
                  statusCol: "text-blue-600 dark:text-blue-400 bg-blue-500/10 border-blue-500/20",
                },
              ].map((row, idx) => (
                <tr
                  key={idx}
                  className="hover:bg-zinc-100 dark:hover:bg-zinc-800/10 transition-colors"
                >
                  ...
                  <td className="py-3.5 px-4">
                    <span
                      className={`inline-flex rounded-full border px-2.5 py-0.5 text-xs font-semibold ${row.statusCol}`}
                    >
                      {row.status}
                    </span>
                  </td>
